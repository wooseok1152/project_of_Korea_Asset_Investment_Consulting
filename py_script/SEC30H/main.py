...
logger = logger.get_logger("SEC30H")

try : 

    today = datetime.today().strftime("%Y%m%d")
    csv_material_file_path = './csv_for_table_insert_material/SEC30H_{}.csv'.format(today)
    ...
    logger.info("batch for inserting data into SEC30H finished")
    logger.info(" ")
