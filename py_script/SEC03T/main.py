...
logger = logger.get_logger("SEC03T")
...
try :
    ...
    df_OHLCV_by_base_date_and_is = make_OHLCV_df(start_date, end_date)
    ...
    logger.info("batch for inserting data into SEC03T finished")
    logger.info(" ")
